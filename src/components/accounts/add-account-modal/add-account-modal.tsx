      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex w-full flex-col gap-6">
        <div className="mt-3 flex w-full flex-col gap-4">
          <div className="flex w-full flex-wrap justify-stretch gap-4">
            <div className="flex w-full min-w-[262px] flex-1 flex-col gap-0.5">
              <Text variant="xs" className="text-gray-500">
                {texts.accountParams.nameTitle}
              </Text>
              <Input
          ...
          <div className="flex w-full flex-col gap-0.5">
            <Text variant="xs" className="text-gray-500">
              {texts.accountParams.descriptionTitle}
            </Text>
            <Input
          ...
          <div className="flex w-full flex-col gap-0.5">
            <Text variant="xs" className="text-gray-500">
              {texts.accountParams.balanceTitle}
            </Text>
            <Input

const texts = {
  accounts: {
    title: 'Счета',
    totalBalance: 'Общая сумма всех счетов',
    addAccount: 'Добавить счет',
    loading: 'Загрузка счетов...',
    repeatAction: {
      title: 'Ошибка загрузки списка счетов',
      description: 'Что-то пошло не так при загрузке списка счетов. Пожалуйста, попробуйте снова.',
    },
    empty: {
      title: 'Список счетов пуст',
      description:
        'Чтобы начать управлять своими деньгами, нажмите "Добавить счет". Вы можете добавить несколько счетов и отслеживать финансы в одном месте.',
    },
  },
  accountCard: {
